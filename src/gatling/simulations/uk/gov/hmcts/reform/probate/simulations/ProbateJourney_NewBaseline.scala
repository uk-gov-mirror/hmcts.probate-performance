...
class ProbateJourney_NewBaseline {
  ...
  setUp(//scn1.inject(rampUsers(25) over (100 seconds)),
        //scn2.inject(rampUsers(25) over (100 seconds)),
        scn3.inject(rampUsers(50) over (100 seconds))
